defmodule CustomEventTest do
  ...
  test "post a custom event" do
    ...
    custom_events = Event.format_custom_events([tr_1])
  ...
  test "Annotate events with user's configured attributes" do
    ...
    TestHelper.restart_harvest_cycle(Collector.CustomEvent.HarvestCycle)
    NewRelic.record(:Event, %{key: "TestEvent"})
  ...
  test "Respect the reservoir_size" do
    ...
    NewRelic.record(:Event, %{key: "TestEvent1"})
    NewRelic.record(:Event, %{key: "TestEvent2"})
    NewRelic.record(:Event, %{key: "TestEvent3"})
    NewRelic.record(:Event, %{key: "TestEvent4"})
    NewRelic.record(:Event, %{key: "TestEvent5"})
