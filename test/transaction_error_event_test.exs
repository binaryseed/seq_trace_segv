defmodule TransactionErrorEventTest do
  ...
  test "post an error event" do
    ...
    error_events = Event.format_errors([er_1])
  ...
  test "user attributes can be truncated" do
    ...
    TestHelper.report_event(Collector.TransactionErrorEvent.HarvestCycle, %Event{
