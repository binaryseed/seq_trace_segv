defmodule NewRelic.DistributedTrace.Plug do
  ...
  def call(conn, _opts), do: trace(conn, Application.get_env(:new_relic, :dt_enabled, true))
  ...
  defp generate_sample?() do
    # TODO: https://source.datanerd.us/agents/agent-specs/blob/master/Distributed-Tracing.md#how-to-calculate-sampled
    :rand.uniform() < Application.get_env(:new_relic, :dt_sample_percentage, 0.10)
  end
