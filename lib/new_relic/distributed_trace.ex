defmodule NewRelic.DistributedTrace do
  @moduledoc """
  https://source.datanerd.us/agents/agent-specs/blob/master/Distributed-Tracing.md
  """
  ...
  def set_tracing_context(context) do
    IO.puts("before: " <> inspect(:seq_trace.get_token()))
    :seq_trace.set_token(:label, 1)
    IO.puts("after: " <> inspect(:seq_trace.get_token()))
